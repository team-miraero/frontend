<template>
  ...
  >
    <div class="mx-auto flex h-20 w-full max-w-[1440px] items-center gap-5 px-8">
      <RouterLink
      ...
      <nav class="flex min-w-0 flex-1 items-stretch justify-center gap-5 self-stretch xl:gap-8">
        <div ref="roadmapDropdownRef" class="relative flex shrink-0 items-stretch">
          ...
          >
            ...
            <span
              class="absolute inset-x-3 bottom-0 h-0.5 origin-left bg-primary transition-transform duration-300 ease-out group-hover:scale-x-100"
