...
const transactions = [
  ...
  {
    transactionId: 7,
    transactionName: '이동통신 요금',
    transactionType: 'EXPENSE',
    amount: -70000,
    categoryId: 2,
    categoryCode: 'TELECOMMUNICATION',
    categoryName: '통신',
    categoryType: 'FIXED',
    transactedAt: '2026-07-12T09:00:00',
  },
  {
    transactionId: 8,
    transactionName: '보험료 자동이체',
    transactionType: 'EXPENSE',
    amount: -120000,
    categoryId: 3,
    ...
    categoryName: '보험',
    categoryType: 'FIXED',
    transactedAt: '2026-07-11T09:00:00',
  },
  {
    transactionId: 9,
    transactionName: '대출 원리금 상환',
    transactionType: 'EXPENSE',
    amount: -150000,
    categoryId: 5,
    ...
    categoryName: '대출상환',
    categoryType: 'FIXED',
    transactedAt: '2026-07-10T09:00:00',
  },
  {
    transactionId: 10,
    transactionName: '적금 자동이체',
    transactionType: 'EXPENSE',
    amount: -200000,
    categoryId: 6,
    ...
    categoryName: '저축',
    categoryType: 'FIXED',
    transactedAt: '2026-07-09T09:00:00',
  },
  {
    transactionId: 11,
    transactionName: 'ETF 적립식 투자',
    transactionType: 'EXPENSE',
    amount: -100000,
    categoryId: 7,
    ...
    categoryName: '투자',
    categoryType: 'FIXED',
    transactedAt: '2026-07-08T09:00:00',
  },
  {
    transactionId: 12,
    transactionName: '영화관',
    ...
    categoryName: '문화',
    categoryType: 'VARIABLE',
    transactedAt: '2026-07-07T19:30:00',
  },
  {
    transactionId: 13,
    transactionName: '연세내과',
    transactionType: 'EXPENSE',
    amount: -50000,
    categoryId: 13,
    ...
    categoryName: '의료',
    categoryType: 'VARIABLE',
    transactedAt: '2026-07-06T14:00:00',
  },
  {
    transactionId: 14,
    transactionName: '생활용품',
    transactionType: 'EXPENSE',
    amount: -30000,
    categoryId: 14,
    categoryCode: 'OTHER',
    categoryName: '기타',
    categoryType: 'VARIABLE',
    transactedAt: '2026-07-05T16:00:00',
  },
]
